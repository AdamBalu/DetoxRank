...
/**
 * Color theme designed using Material Design 3 theme creator
 */
// Light palette: calm periwinkle indigo with warm neutrals, matched to the
// dark theme's lavender family
val md_theme_light_primary = Color(0xFF5566C9)
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFDFE3FF)
val md_theme_light_onPrimaryContainer = Color(0xFF14205A)
val md_theme_light_secondary = Color(0xFF3D7A94)
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFD2E9F5)
val md_theme_light_onSecondaryContainer = Color(0xFF0B2533)
val md_theme_light_tertiary = Color(0xFF47793C)
val md_theme_light_onTertiary = Color(0xFFFFFFFF)
val md_theme_light_tertiaryContainer = Color(0xFFC4EDB4)
val md_theme_light_onTertiaryContainer = Color(0xFF0E2905)
val md_theme_light_error = Color(0xFFB3403C)
val md_theme_light_errorContainer = Color(0xFFF9DEDA)
val md_theme_light_onError = Color(0xFFFFFFFF)
val md_theme_light_onErrorContainer = Color(0xFF3E0705)
val md_theme_light_background = Color(0xFFFAF9F5)
val md_theme_light_onBackground = Color(0xFF1B1C22)
val md_theme_light_surface = Color(0xFFFAF9F5)
val md_theme_light_onSurface = Color(0xFF1B1C22)
val md_theme_light_surfaceVariant = Color(0xFFE6E3DE)
val md_theme_light_onSurfaceVariant = Color(0xFF4A4944)
val md_theme_light_outline = Color(0xFF79776F)
val md_theme_light_inverseOnSurface = Color(0xFFF2F0EA)
val md_theme_light_inverseSurface = Color(0xFF2F3036)
val md_theme_light_inversePrimary = Color(0xFFB7C4FF)
val md_theme_light_shadow = Color(0xFF000000)
val md_theme_light_surfaceTint = Color(0xFF5566C9)
val md_theme_light_outlineVariant = Color(0xFFCBC8C0)
...
val md_theme_light_tertiaryContainerVariant = Color(0xFFDCF0CB)
